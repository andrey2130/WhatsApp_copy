...
class AboutScreenIos extends StatefulWidget {
  const AboutScreenIos({super.key});

  @override
  State<AboutScreenIos> createState() => _AboutScreenIosState();
}

class _AboutScreenIosState extends State<AboutScreenIos> {
