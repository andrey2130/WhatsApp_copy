...
mixin _$DeleteMessageParams {
 ...
 String get senderId; String get chatId; String get messageId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteMessageParams&&(identical(other.senderId, senderId) || other.senderId == senderId)&&(identical(other.chatId, chatId) || other.chatId == chatId)&&(identical(other.messageId, messageId) || other.messageId == messageId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,senderId,chatId,messageId);

@override
String toString() {
  return 'DeleteMessageParams(senderId: $senderId, chatId: $chatId, messageId: $messageId)';
}
...
@useResult
$Res call({
 String senderId, String chatId, String messageId
});
...
/// Create a copy of DeleteMessageParams
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? senderId = null,Object? chatId = null,Object? messageId = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String senderId,  String chatId,  String messageId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DeleteMessageParams() when $default != null:
return $default(_that.senderId,_that.chatId,_that.messageId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String senderId,  String chatId,  String messageId)  $default,) {final _that = this;
switch (_that) {
case _DeleteMessageParams():
return $default(_that.senderId,_that.chatId,_that.messageId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String senderId,  String chatId,  String messageId)?  $default,) {final _that = this;
switch (_that) {
case _DeleteMessageParams() when $default != null:
return $default(_that.senderId,_that.chatId,_that.messageId);case _:
  return null;
...
class _DeleteMessageParams implements DeleteMessageParams {
  const _DeleteMessageParams({required this.senderId, required this.chatId, required this.messageId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DeleteMessageParams&&(identical(other.senderId, senderId) || other.senderId == senderId)&&(identical(other.chatId, chatId) || other.chatId == chatId)&&(identical(other.messageId, messageId) || other.messageId == messageId));
}
...
/// Create a copy of DeleteMessageParams
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? senderId = null,Object? chatId = null,Object? messageId = null,}) {
